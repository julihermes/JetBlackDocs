...
/** Where the item sits on the map — the one thing here that comes from the hack's doc rather than PokeAPI, so it's marked. */
    ...
    <div className={styles.card}>
      <div className={styles.cardHead}>
        ...
        <span className={styles.cardTitle}>
          ...
          <LocationLine location={entry.location} />
        </span>
      </div>
            ...
            <div key={slug} className={styles.card}>
              <div className={styles.cardHead}>
                ...
                <span className={styles.cardTitle}>
                  ...
                  <span className={styles.category}>{categoryLabel(info.category)}</span>
                </span>
              </div>
