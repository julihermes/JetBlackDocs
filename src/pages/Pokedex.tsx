...
export function Pokedex() {
  ...
  const filtered = useMemo(() => {
    ...
    const list = [...state.data].sort((a, b) => a.dexNumber - b.dexNumber);
  ...
  return (
    <main className="page">
      <PageHeader eyebrow="DEPARTURE · DEX" title="POKÉDEX" subtitle="Every species available in JetBlack — base stats, abilities, and full level-up learnsets, with vanilla changes called out." />
