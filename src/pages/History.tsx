...
export function History() {
  ...
  return (
    <main className="page">
      <PageHeader eyebrow="DEPARTURE · LOG" title="VERSION HISTORY" subtitle="What changed in each JetBlack release, most recent first. Every other page already reflects the current v1.7 state." />
